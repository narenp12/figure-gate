...
def test_the_symlinks_were_found():
    ...
    not fail them -- it deletes them. Twenty-eight pages and images point out of
    ...
    """
    assert len(symlinks()) == 28, (
        f"found {len(symlinks())} symlinks under docs/, expected 28 - if the "
